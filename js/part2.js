...
// V2内容: 引入强思维链，深度提取角色设定和剧情大纲
let prompt = getLanguagePrefix() + `你是专业的小说世界书生成专家和剧情分析师。请使用**思维链推理**仔细阅读提供的小说内容，深度提取关键信息，生成高质量的世界书条目。

## 🧠 思维链分析要求
在生成内容前，请先进行以下思考（不需要输出思考过程）：
1. **角色心理分析**：分析角色的核心动机、内在冲突、性格成因
2. **关系网络推理**：推断角色之间的深层关系和互动模式
3. **成长轨迹追踪**：识别角色在故事中的变化和转折点
4. **世界观构建**：理解故事背景的社会结构、权力体系、文化特征
5. **剧情逻辑梳理**：提取主线、支线、冲突点、转折点

## 📋 核心要求
1. **必须基于提供的具体小说内容**，充分利用你的知识库进行深度分析
2. **提取文中明确出现的信息**，并进行合理的心理和动机推断
3. **关键词必须是文中实际出现的名称**，用逗号分隔
4. **内容使用markdown格式**，层层嵌套，结构清晰
5. **角色分析要深入**：包含MBTI、心理状态、成长轨迹、隐藏动机等
...
"角色真实姓名": {
"关键词": ["真实姓名", "称呼1", "称呼2", "绰号"],
"内容": "## 基础信息\n**姓名**: 全名\n**性别**: 性别\n**年龄**: 实际年龄 / 外观年龄\n**身份**: 社会身份、职业、地位\n\n## 性格分析\n**MBTI类型**: [必须] 根据行为模式推断，如有变化说明原因\n**核心特质**: 3-5个关键性格特征\n**行为模式**: 典型的行为方式和反应模式\n**心理状态**: 当前的心理健康状况、压力源\n**隐藏动机**: 深层次的欲望和恐惧\n\n## 外貌特征\n**整体印象**: 第一印象描述\n**细节特征**: 身高、体型、发色、眼睛、标志性特征\n**着装风格**: 日常穿着习惯和风格偏好\n\n## 能力与技能\n**核心能力**: 最擅长的领域\n**特殊技能**: 独特的技能或天赋\n**战斗力**: [如适用] 战斗相关能力\n**弱点**: 能力上的短板和致命弱点\n\n## 人际关系\n**重要关系**: 与其他角色的关系网络\n**情感纽带**: 深层情感连接\n**冲突关系**: 敌对或紧张关系\n\n## 成长轨迹\n**起点**: 故事开始时的状态\n**转折点**: 关键的改变时刻\n**当前状态**: 最新的发展状况\n**未来走向**: [如有暗示] 可能的发展方向\n\n## 背景故事\n**童年经历**: 塑造性格的早期事件\n**重要事件**: 人生中的关键事件\n**创伤与成就**: 影响深远的经历\n\n## 话语特征\n**语言风格**: 说话方式和用词习惯\n**口头禅**: 常用语句\n**典型对话**: 2-3句原文对话示例\n\n## 深度分析\n**角色功能**: 在故事中的作用\n**象征意义**: 角色代表的主题或理念\n**心理动力学**: 驱动角色行为的深层心理机制"
}
},
"地点": {
"地点真实名称": {
